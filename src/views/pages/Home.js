                                                  ...
                                                  return (
                                                    <div key={work.id} className="col headline">
                                                      <div className="card pdf-rounded-xl overflow-hidden border-0 shadow-xl shadow-blue-50">
                                                        <img src={Home_Img_1} className="img-fiuid card-img-top" alt="Home img" />
                                ...
                                <div className="container">
                                  <div className="row justify-content-center">
                                    <div className="col-lg-12">
                                      <section className="container">
                                        <div className="row">
                                          <div className="col-lg-6"><h4 className="headline Walone-Bold">Our Services</h4></div>
                                          <div className="col-lg-6">
                                            <p className="text-secondary headline">As a strategic partner, we create a working product with a thoughtful and large-scale architecture. We launch, support and development.</p>
                                          </div>
                                        ...
                                        <div className="row">
                                          <div className="col">
                                            <div className="my-lg-5 py-5">
                                              <Link to="/story" className="text-decoration-none text-secordary">
